        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="border px-4 py-2 text-center">
                    <button wire:click="editar({{$libro->id}})" class="bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4">Editar</button>
                    <button wire:click="borrar({{$libro->id}})" class="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4">Borrar</button>
                </td>
            </tr>
            @endforeach
        </tbody>
